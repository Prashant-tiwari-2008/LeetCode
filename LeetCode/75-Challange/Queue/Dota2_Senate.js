...
var predictPartyVictory = function(senate) {
    ...
    // Step 1: Fill both queues with their respective indices
    ...
    // Step 2: Simulate the senate rounds
    while (radiantQueue.length > 0 && direQueue.length > 0) {
        ...
        if (radiantIndex < direIndex) {
            // Radiant wins this round, move them to the back of their queue
            radiantQueue.push(radiantIndex + senate.length);
        } else {
            // Dire wins this round, move them to the back of their queue
